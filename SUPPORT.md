...
| Item | Support |
| --- | --- |
| Unbihexium release | The latest 2.0.x release (2.0.1) and the main branch. Fixes are released in new patch versions; older patch versions and the 1.0.x series are not updated. |

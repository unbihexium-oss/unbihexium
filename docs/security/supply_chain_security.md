...
| Applies to | Unbihexium 2.0.0 and the main branch, the release workflow and the container image |
...
- **Unsigned 1.0.x releases.** v1.0.0 and v1.0.1 have no signatures or provenance, and the v1.0.1 GitHub checksums do not match PyPI (Section 6.4). 2.0.0 is the first release built with signatures and provenance; users of 1.0.x should upgrade.

# Model Card: insurance_underwriting_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | insurance_underwriting_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Insurance Underwriting is a regression model designed for geospatial applications.

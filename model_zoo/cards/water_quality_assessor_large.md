# Model Card: water_quality_assessor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | water_quality_assessor_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Water Quality Assessor is a regression model designed for geospatial applications.

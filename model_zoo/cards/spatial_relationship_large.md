# Model Card: spatial_relationship_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | spatial_relationship_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Spatial Relationship is a regression model designed for geospatial applications.

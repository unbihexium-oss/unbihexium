# Model Card: sar_oil_spill_detector_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | sar_oil_spill_detector_large |
| Task | Segmentation |
| Architecture | UNET |
| Variant | large |
| Resolution | 128x128 |
...
Sar Oil Spill Detector is a segmentation model designed for geospatial applications.

# Model Card: sar_subsidence_monitor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | sar_subsidence_monitor_large |
| Task | Regression |
| Architecture | CNN |
| Variant | large |
| Resolution | 128x128 |
...
Sar Subsidence Monitor is a regression model designed for geospatial applications.

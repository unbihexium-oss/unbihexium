# Model Card: plowed_land_detector_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | plowed_land_detector_large |
| Task | Segmentation |
| Architecture | UNET |
| Variant | large |
| Resolution | 128x128 |
...
Plowed Land Detector is a segmentation model designed for geospatial applications.

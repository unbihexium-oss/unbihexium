# Model Card: forest_density_estimator_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | forest_density_estimator_large |
| Task | Regression |
| Architecture | CNN |
| Variant | large |
| Resolution | 128x128 |
...
Forest Density Estimator is a regression model designed for geospatial applications.

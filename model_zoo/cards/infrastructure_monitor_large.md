# Model Card: infrastructure_monitor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | infrastructure_monitor_large |
| Task | Segmentation |
...
Infrastructure Monitor is a segmentation model designed for geospatial applications.

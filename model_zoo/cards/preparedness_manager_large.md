# Model Card: preparedness_manager_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | preparedness_manager_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Preparedness Manager is a regression model designed for geospatial applications.

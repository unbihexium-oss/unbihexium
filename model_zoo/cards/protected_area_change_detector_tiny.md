# Model Card: protected_area_change_detector_tiny

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | protected_area_change_detector_tiny |
| Task | Segmentation |
...
Protected Area Change Detector is a segmentation model designed for geospatial applications.

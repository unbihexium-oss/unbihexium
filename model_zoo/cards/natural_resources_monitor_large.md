# Model Card: natural_resources_monitor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | natural_resources_monitor_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Natural Resources Monitor is a regression model designed for geospatial applications.

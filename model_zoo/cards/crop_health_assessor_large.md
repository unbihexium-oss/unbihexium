# Model Card: crop_health_assessor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | crop_health_assessor_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Crop Health Assessor is a regression model designed for geospatial applications.

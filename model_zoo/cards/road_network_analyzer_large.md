# Model Card: road_network_analyzer_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | road_network_analyzer_large |
| Task | Segmentation |
| Architecture | UNET |
| Variant | large |
| Resolution | 128x128 |
...
Road Network Analyzer is a segmentation model designed for geospatial applications.

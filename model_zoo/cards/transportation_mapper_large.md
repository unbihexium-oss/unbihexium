# Model Card: transportation_mapper_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | transportation_mapper_large |
| Task | Segmentation |
| Architecture | UNET |
| Variant | large |
| Resolution | 128x128 |
...
Transportation Mapper is a segmentation model designed for geospatial applications.

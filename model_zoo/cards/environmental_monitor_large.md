# Model Card: environmental_monitor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | environmental_monitor_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Environmental Monitor is a regression model designed for geospatial applications.

# Model Card: economic_spatial_assessor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | economic_spatial_assessor_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Economic Spatial Assessor is a regression model designed for geospatial applications.

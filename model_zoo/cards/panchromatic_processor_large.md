# Model Card: panchromatic_processor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | panchromatic_processor_large |
| Task | Enhancement |
| Architecture | CNN |
| Variant | large |
| Resolution | 128x128 |
...
Panchromatic Processor is a enhancement model designed for geospatial applications.

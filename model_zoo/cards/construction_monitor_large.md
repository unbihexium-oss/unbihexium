# Model Card: construction_monitor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | construction_monitor_large |
| Task | Segmentation |
...
Construction Monitor is a segmentation model designed for geospatial applications.

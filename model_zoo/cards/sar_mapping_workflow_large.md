# Model Card: sar_mapping_workflow_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | sar_mapping_workflow_large |
| Task | Enhancement |
| Architecture | CNN |
| Variant | large |
| Resolution | 128x128 |
...
Sar Mapping Workflow is a enhancement model designed for geospatial applications.

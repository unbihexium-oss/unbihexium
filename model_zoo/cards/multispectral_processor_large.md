# Model Card: multispectral_processor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | multispectral_processor_large |
| Task | Enhancement |
| Architecture | CNN |
| Variant | large |
| Resolution | 128x128 |
...
Multispectral Processor is a enhancement model designed for geospatial applications.

# Model Card: pipeline_route_planner_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | pipeline_route_planner_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Pipeline Route Planner is a regression model designed for geospatial applications.

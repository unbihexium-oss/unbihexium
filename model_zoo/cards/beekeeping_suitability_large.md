# Model Card: beekeeping_suitability_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | beekeeping_suitability_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Beekeeping Suitability is a regression model designed for geospatial applications.

# Model Card: water_surface_detector_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | water_surface_detector_large |
| Task | Segmentation |
| Architecture | UNET |
| Variant | large |
| Resolution | 128x128 |
...
Water Surface Detector is a segmentation model designed for geospatial applications.

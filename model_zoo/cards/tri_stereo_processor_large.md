# Model Card: tri_stereo_processor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | tri_stereo_processor_large |
| Task | Regression |
| Architecture | CNN |
| Variant | large |
| Resolution | 128x128 |
...
Tri Stereo Processor is a regression model designed for geospatial applications.

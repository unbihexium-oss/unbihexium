...
Normalized Difference Vegetation Index, (NIR - RED) / (NIR + RED) (Rouse et al., 1974).
...
| --- | --- | --- | --- |
| `ndvi_calculator_tiny` | 0 | 256 | `e3b0c44298fc1c14` |
| `ndvi_calculator_base` | 0 | 256 | `e3b0c44298fc1c14` |
| `ndvi_calculator_large` | 0 | 512 | `e3b0c44298fc1c14` |
| `ndvi_calculator_mega` | 0 | 512 | `e3b0c44298fc1c14` |
...
model = load_model("ndvi_calculator_base")  # verified starter weights
```

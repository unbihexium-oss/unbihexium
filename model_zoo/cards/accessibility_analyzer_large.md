# Model Card: accessibility_analyzer_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | accessibility_analyzer_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Accessibility Analyzer is a regression model designed for geospatial applications.

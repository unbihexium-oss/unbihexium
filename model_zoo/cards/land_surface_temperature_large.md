# Model Card: land_surface_temperature_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | land_surface_temperature_large |
| Task | Regression |
| Architecture | CNN |
| Variant | large |
| Resolution | 128x128 |
...
Land Surface Temperature is a regression model designed for geospatial applications.

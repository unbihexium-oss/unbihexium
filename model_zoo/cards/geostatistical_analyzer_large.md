# Model Card: geostatistical_analyzer_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | geostatistical_analyzer_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Geostatistical Analyzer is a regression model designed for geospatial applications.

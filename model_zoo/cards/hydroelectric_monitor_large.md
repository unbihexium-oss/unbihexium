# Model Card: hydroelectric_monitor_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | hydroelectric_monitor_large |
| Task | Regression |
| Architecture | MLP |
| Variant | large |
| Resolution | 128x128 |
...
Hydroelectric Monitor is a regression model designed for geospatial applications.

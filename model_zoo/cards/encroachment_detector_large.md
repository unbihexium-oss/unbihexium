# Model Card: encroachment_detector_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | encroachment_detector_large |
| Task | Detection |
...
Encroachment Detector is a detection model designed for geospatial applications.

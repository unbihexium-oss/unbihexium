# Model Card: land_degradation_detector_large

## Overview

| Property | Value |
| ---------- | ------- |
| Model ID | land_degradation_detector_large |
| Task | Segmentation |
| Architecture | UNET |
| Variant | large |
| Resolution | 128x128 |
...
Land Degradation Detector is a segmentation model designed for geospatial applications.
